        ...
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="category_id"
                        class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-slate-400 focus:bg-white @error('category_id') border-rose-300 focus:border-rose-400 @enderror">
            ...
            <div>
                ...
                <textarea name="description" rows="5"
                    class="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none transition focus:border-slate-400 focus:bg-white @error('description') border-rose-300 focus:border-rose-400 @enderror">{{ old('description') }}</textarea>
