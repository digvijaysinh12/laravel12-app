...
@section('content')
<div style="max-width:1000px; margin:auto;" data-order-id="{{ $order->id }}">
    <div style="background:#fff; padding:15px; border:1px solid #ddd; margin-bottom:15px;">
        <div style="display:flex; justify-content:space-between; align-items:center;">
            ...
            <div>
                <span style="padding:5px 10px; background:#f0f0f0; font-size:13px;" data-order-current-status>
    ...
    <div style="display:flex; gap:15px;">
                ...
                @foreach($order->items as $item)
                    <div style="display:flex; justify-content:space-between; border-bottom:1px solid #eee; padding:10px 0;">
                        ...
                        <div style="text-align:right;">
                            <p style="margin:0;">INR {{ number_format($item->price, 2) }}</p>
                            <p style="margin:0; font-weight:bold;">
        ...
        <div style="flex:1;">
            <div style="background:#fff; border:1px solid #ddd; padding:15px; margin-bottom:15px;">
                <h3>Price Details</h3>
                <p>Total: INR {{ number_format($order->total_amount, 2) }}</p>
                <hr>
            ...
            <div style="background:#fff; border:1px solid #ddd; padding:15px; margin-top:15px;">
                <h4 style="margin-top:0;">Live Status Updates</h4>
                <div data-order-status-feed style="display:flex; flex-direction:column; gap:10px;">
                    <div style="padding:10px; border:1px solid #eee; font-size:13px; color:#555;">
